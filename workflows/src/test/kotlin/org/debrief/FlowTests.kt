...
import org.debrief.flows.IssueAssetFlow
import org.debrief.flows.QueryAssetFlow
import org.debrief.flows.TransferAssetFlow
...
class FlowTests {
    ...
    */
    ...
    fun setup() {
        network = MockNetwork(MockNetworkParameters(cordappsForAllNodes = listOf(
                TestCordapp.findCordapp("org.debrief.contracts"),
                TestCordapp.findCordapp("org.debrief.flows"),
    ...
    */
    ...
    fun `asset transfer`() {
        ...
        val future2 = accountServiceB.createAccount("MOCK_DEBRIEF_ACCOUNT")
